...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/alien-chain/alien/releases/download/latest/alien_latest_darwin_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/alien-chain/alien/releases/download/latest/alien_latest_linux_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	*) fail "No asset for platform ${OS}-${ARCH}";;
	...
	if [[ $FTYPE = ".gz" ]]; then
		...
		bash -c "$GET $URL" > "alien_${OS}_${ARCH}" || fail "download failed"
	else
